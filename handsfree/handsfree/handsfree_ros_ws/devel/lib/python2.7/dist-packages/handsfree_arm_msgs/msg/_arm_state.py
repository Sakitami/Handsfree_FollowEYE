...
"""autogenerated by genpy from handsfree_arm_msgs/arm_state.msg. Do not edit."""
import sys
...
class arm_state(genpy.Message):
  _md5sum = "89ee41d32f087562c4c5ab41d1874e2c"
  _type = "handsfree_arm_msgs/arm_state"
...
float64 yaw
"""
  __slots__ = ['header','status','voltage','current','joints','end_pose','gripper_pose']
  _slot_types = ['std_msgs/Header','uint8','float32','float32','handsfree_arm_msgs/arm_joints_state','handsfree_arm_msgs/PoseEuler','handsfree_arm_msgs/PoseEuler']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,status,voltage,current,joints,end_pose,gripper_pose
    ...
    if args or kwds:
      ...
      if self.joints is None:
        self.joints = handsfree_arm_msgs.msg.arm_joints_state()
      if self.end_pose is None:
        self.end_pose = handsfree_arm_msgs.msg.PoseEuler()
      if self.gripper_pose is None:
        self.gripper_pose = handsfree_arm_msgs.msg.PoseEuler()
    else:
      self.header = std_msgs.msg.Header()
      self.status = 0
      self.voltage = 0.
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_12d().pack(_x.end_pose.x, _x.end_pose.y, _x.end_pose.z, _x.end_pose.roll, _x.end_pose.pitch, _x.end_pose.yaw, _x.gripper_pose.x, _x.gripper_pose.y, _x.gripper_pose.z, _x.gripper_pose.roll, _x.gripper_pose.pitch, _x.gripper_pose.yaw))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.end_pose.x, _x.end_pose.y, _x.end_pose.z, _x.end_pose.roll, _x.end_pose.pitch, _x.end_pose.yaw, _x.gripper_pose.x, _x.gripper_pose.y, _x.gripper_pose.z, _x.gripper_pose.roll, _x.gripper_pose.pitch, _x.gripper_pose.yaw,) = _get_struct_12d().unpack(str[start:end])
      return self
