...
"""autogenerated by genpy from handsfree_arm_msgs/ArmBehaviorAction.msg. Do not edit."""
import sys
...
class ArmBehaviorAction(genpy.Message):
  _md5sum = "917862a493d502e8d6bee12c146f7298"
  _type = "handsfree_arm_msgs/ArmBehaviorAction"
...
"""
  ...
  _slot_types = ['handsfree_arm_msgs/ArmBehaviorActionGoal','handsfree_arm_msgs/ArmBehaviorActionResult','handsfree_arm_msgs/ArmBehaviorActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmBehaviorAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = handsfree_arm_msgs.msg.ArmBehaviorActionGoal()
      if self.action_result is None:
        self.action_result = handsfree_arm_msgs.msg.ArmBehaviorActionResult()
      if self.action_feedback is None:
        self.action_feedback = handsfree_arm_msgs.msg.ArmBehaviorActionFeedback()
    else:
      self.action_goal = handsfree_arm_msgs.msg.ArmBehaviorActionGoal()
      self.action_result = handsfree_arm_msgs.msg.ArmBehaviorActionResult()
      self.action_feedback = handsfree_arm_msgs.msg.ArmBehaviorActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.gripper_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_result.result.result_bool, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.action_feedback.feedback.feedback_bool))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.gripper_type = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.gripper_type = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.result_bool, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      self.action_result.result.result_bool = bool(self.action_result.result.result_bool)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.feedback_bool,) = _get_struct_d().unpack(str[start:end])
      return self
