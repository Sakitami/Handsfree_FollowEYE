...
"""autogenerated by genpy from handsfree_arm_msgs/ArmBehaviorActionFeedback.msg. Do not edit."""
import sys
...
class ArmBehaviorActionFeedback(genpy.Message):
  _md5sum = "b81ce29462b043592bd009ef0de49497"
  _type = "handsfree_arm_msgs/ArmBehaviorActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','handsfree_arm_msgs/ArmBehaviorFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ArmBehaviorActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = handsfree_arm_msgs.msg.ArmBehaviorFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = handsfree_arm_msgs.msg.ArmBehaviorFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_d().pack(self.feedback.feedback_bool))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feedback_bool,) = _get_struct_d().unpack(str[start:end])
      return self
