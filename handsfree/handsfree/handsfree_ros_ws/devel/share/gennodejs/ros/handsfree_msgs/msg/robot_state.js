...
class robot_state {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('power_remain')) {
        this.power_remain = initObj.power_remain
      }
      else {
        this.power_remain = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.system_time, buffer, bufferOffset);
    ...
    // Serialize message field [power_remain]
    bufferOffset = _serializer.float32(obj.power_remain, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.system_time = _deserializer.float32(buffer, bufferOffset);
    ...
    // Deserialize message field [power_remain]
    data.power_remain = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.power_remain !== undefined) {
      resolved.power_remain = msg.power_remain;
    }
    else {
      resolved.power_remain = 0.0
    }
