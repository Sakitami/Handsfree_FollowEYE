...
(cl:defclass <SetParamList-request> (roslisp-msg-protocol:ros-message)
  ((param
    :reader param
    :initarg :param
    :type handsfree_msgs-msg:parameters
    :initform (cl:make-instance 'handsfree_msgs-msg:parameters)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SetParamList-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetParamList-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handsfree_msgs-srv:<SetParamList-request> is deprecated: use handsfree_msgs-srv:SetParamList-request instead.")))

(cl:ensure-generic-function 'param-val :lambda-list '(m))
(cl:defmethod param-val ((m <SetParamList-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsfree_msgs-srv:param-val is deprecated.  Use handsfree_msgs-srv:param instead.")
  (param m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetParamList-request>)))
  ...
  "handsfree_msgs/SetParamListRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetParamList-request)))
  "Returns string type for a service object of type 'SetParamList-request"
  "handsfree_msgs/SetParamListRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetParamList-request>)))
  ...
  (cl:format cl:nil "handsfree_msgs/parameters param~%~%================================================================================~%MSG: handsfree_msgs/parameters~%string[] param_name~%float64[] values~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetParamList-request)))
  "Returns full string definition for message of type 'SetParamList-request"
  (cl:format cl:nil "handsfree_msgs/parameters param~%~%================================================================================~%MSG: handsfree_msgs/parameters~%string[] param_name~%float64[] values~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <SetParamList-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetParamList-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handsfree_msgs-srv:<SetParamList-response> is deprecated: use handsfree_msgs-srv:SetParamList-response instead.")))

(cl:ensure-generic-function 'succ-val :lambda-list '(m))
(cl:defmethod succ-val ((m <SetParamList-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsfree_msgs-srv:succ-val is deprecated.  Use handsfree_msgs-srv:succ instead.")
  (succ m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetParamList-response>)))
  ...
  "handsfree_msgs/SetParamListResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetParamList-response)))
  "Returns string type for a service object of type 'SetParamList-response"
  "handsfree_msgs/SetParamListResponse")
