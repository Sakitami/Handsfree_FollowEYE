...
(cl:defmethod cl:initialize-instance :after ((m <parameters>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'parameters)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handsfree_msgs-msg:<parameters> is deprecated: use handsfree_msgs-msg:parameters instead.")))

(cl:ensure-generic-function 'param_name-val :lambda-list '(m))
(cl:defmethod param_name-val ((m <parameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsfree_msgs-msg:param_name-val is deprecated.  Use handsfree_msgs-msg:param_name instead.")
  (param_name m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <parameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsfree_msgs-msg:values-val is deprecated.  Use handsfree_msgs-msg:values instead.")
  (values m))
