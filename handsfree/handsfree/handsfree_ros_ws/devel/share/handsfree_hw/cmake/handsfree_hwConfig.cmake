...
if("TRUE" STREQUAL "TRUE")
  set(handsfree_hw_SOURCE_PREFIX /home/handsfree/handsfree/handsfree_ros_ws/src/handsfree/handsfree_hw)
  set(handsfree_hw_DEVEL_PREFIX /home/handsfree/handsfree/handsfree_ros_ws/devel)
  ...
  set(handsfree_hw_INSTALL_PREFIX /home/handsfree/handsfree/handsfree_ros_ws/install)
...
if(NOT "/home/handsfree/handsfree/handsfree_ros_ws/src/handsfree/handsfree_hw/include " STREQUAL " ")
  set(handsfree_hw_INCLUDE_DIRS "")
  set(_include_dirs "/home/handsfree/handsfree/handsfree_ros_ws/src/handsfree/handsfree_hw/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'handsfree_hw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsfree/handsfree/handsfree_ros_ws/src/handsfree/handsfree_hw/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT handsfree_hw_NUM_DUMMY_TARGETS)
      set(handsfree_hw_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::handsfree_hw::wrapped-linker-option${handsfree_hw_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR handsfree_hw_NUM_DUMMY_TARGETS "${handsfree_hw_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::handsfree_hw::wrapped-linker-option${handsfree_hw_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND handsfree_hw_LIBRARIES "${interface_target_name}")
