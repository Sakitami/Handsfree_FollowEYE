...
if("TRUE" STREQUAL "TRUE")
  set(xfei_asr_SOURCE_PREFIX /home/handsfree/handsfree/handsfree_ros_ws/src/xfei_asr)
  set(xfei_asr_DEVEL_PREFIX /home/handsfree/handsfree/handsfree_ros_ws/devel)
  set(xfei_asr_INSTALL_PREFIX "")
  set(xfei_asr_PREFIX ${xfei_asr_DEVEL_PREFIX})
else()
  set(xfei_asr_SOURCE_PREFIX "")
  set(xfei_asr_DEVEL_PREFIX "")
  set(xfei_asr_INSTALL_PREFIX /home/handsfree/handsfree/handsfree_ros_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'ubu <ubu@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'xfei_asr' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'xfei_asr' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/handsfree/handsfree/handsfree_ros_ws/src/xfei_asr/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT xfei_asr_NUM_DUMMY_TARGETS)
      set(xfei_asr_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::xfei_asr::wrapped-linker-option${xfei_asr_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR xfei_asr_NUM_DUMMY_TARGETS "${xfei_asr_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::xfei_asr::wrapped-linker-option${xfei_asr_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND xfei_asr_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${xfei_asr_dep}_FOUND)
      find_package(${xfei_asr_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${xfei_asr_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
