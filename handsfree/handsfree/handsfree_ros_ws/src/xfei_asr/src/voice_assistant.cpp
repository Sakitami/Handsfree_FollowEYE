...
void voiceWordsCallback(const std_msgs::String::ConstPtr& msg)
{
  ...
  const char* filename             = "tts_sample.wav"; //合成的语音文件名称
        ...
        std::vector<string> ves;
	int flag = 0;
	std::string dataString = msg->data;
	
	split_String(ves, dataString);
...
// int flag = dataString.compare("Lucky.") == 0;
// std::cout << "True or False: " << flag << std::endl;

     if(flag == 1)
    {
        char nameString[40] = "我是你的语音小助手Lucky!";
        text = nameString;
        std::cout<<text<<std::endl;
    }
    else if(dataString.compare("你是谁？") == 0)
    {
        char nameString[40] = "我是你的语音小助手Lucky!";
        text = nameString;
        std::cout<<text<<std::endl;
