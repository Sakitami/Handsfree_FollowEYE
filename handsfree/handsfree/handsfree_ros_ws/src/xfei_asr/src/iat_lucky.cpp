...
static void show_result(char *string, char is_over)
{
	...
	}else if(strcmp(string, "自由模式。")  == 0){
		system("mplayer /home/handsfree/handsfree/handsfree_ros_ws/src/xfei_asr/feedback_voice/random_walk.wav");
		system("rosrun handsfree_tutorials set_four_goals.py");	
	}else if(strcmp(string, "速度增加。")  == 0){
		system("sh ./speed_up.sh");		
	}else if(strcmp(string, "速度减少。")  == 0){
		system("./speed_down.sh");		
	}else if(strcmp(string, "好兄弟，你在吗？") == 0 || strcmp(string, "兄弟，你在吗") == 0){
		printf("***************************************************************");
		system("mplayer /home/handsfree/handsfree/handsfree_ros_ws/src/xfei_asr/feedback_voice/awake.wav");
		// system("./NavigationMode.sh")
	}
	else if(strcmp(string, "你可以做什么") == 0){
		system("mplayer /home/handsfree/handsfree/handsfree_ros_ws/src/xfei_asr/feedback_voice/function.wav");
	}
...
int main(int argc, char* argv[])
{
    ...
    while(ros::ok())
    {
        ...
        if (flag){
	        ...
	        int ret = MSP_SUCCESS;
    	    const char* login_params = "appid = 2e922ccc, work_dir = .";
